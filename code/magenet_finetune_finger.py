...
# Training directory
train_dir = '/Users/liu/Desktop/CMPT-726-Machine Learning material/TestData-deep/BiometrikaTrain'
# Testing directory
test_dir = '/Users/liu/Desktop/CMPT-726-Machine Learning material/TestData-deep/BiometrikaTest'
...
x = Dense(32, activation='tanh')(base_model.get_layer('flatten').output) # activation is tanh ?
x = Dropout(0.5)(x)
